...
local OPTIONAL_ENV=("APP" "DESCRIPTION" "DEBUG" "BUILD_VERSION" "BUILD_HOST" "COPY_REGIONS" "VPC_ID" "VSWITCH_ID" "VPC_HTTP_PROXY" "VPC_HTTPS_PROXY" "ALIYUN_CLOUDMONITOR_VERSION" "ALIYUNGOCLI_VERSION" "ALIYUNPYCLI_VERSION" "YQ_VERSION" "TERMTOSVG_VERSION")