...
local OPTIONAL_ENV=("APP" "DESCRIPTION" "DEBUG" "AWS_SESSION_TOKEN" "BUILD_VERSION" "BUILD_HOST" "COPY_REGIONS" "VPC_ID" "SUBNET_ID" "VPC_HTTP_PROXY" "VPC_HTTPS_PROXY" "VPC_NO_PROXY" "YQ_VERSION" "TERMTOSVG_VERSION")